...
mC <- read.table('H1_Mhemi_mCHG_Alu_Start.txt', sep='\t', header=T)
...
p <- myplot({
	...
	mtext('Mhemi-seq mCHG (%)', side=2, cex=0.9, line=1)
	par(new=TRUE)
...
plotsave(p, file='fig6.H1_Mhemi_MNase_Alu_start.pdf', height=2.3, width=3.2, units='in')

mC <- read.table('H1_BS_mCHG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
p <- myplot({
	...
	barplot(coMC, beside=TRUE, col=c('#E69F00', '#708090'), border=c('#E69F00', '#708090'), ylim=c(-34, 34),
		axes=F, xpd=F)
	axis(2, at=c(-32,0,32), labels=c(32,0,32), tcl=-.1, lwd=1, lwd.ticks=1, las=0, cex.axis=.8, mgp=c(0, .05, 0))
	mtext('BS-seq mCHG (%)', side=2, cex=0.9, line=1)
	par(new=TRUE)
	plot(comSignal$Distance, comSignal$Signal, type='l', col='#000000', lwd=1, ylim=c(0, .8),,
		axes=F, xpd=F)
	axis(1, at=c(-100,0,100,200,300), labels=c(-100,0,100,200,300), tcl=-.1, lwd=1, lwd.ticks=1, las=1, cex.axis=.8, mgp=c(0, 0, 0))
...
plotsave(p, file='fig6.H1_BS_MNase_Alu_start.pdf', height=2.3, width=3.2, units='in')



mC <- read.table('H9_Mhemi_mCHG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
p <- myplot({
	...
	axis(1, at=c(-100,0,100,200,300), labels=c(-100,0,100,200,300), tcl=-.1, lwd=1, lwd.ticks=1, las=1, cex.axis=.8, mgp=c(0, 0, 0))
	mtext('Distance from Alu start sites (bp)', side=1, cex=0.9, line=1)
	axis(4, at=c(0,.2,.4), labels=c(0,.2,.4), tcl=-.1, lwd=1, lwd.ticks=1, las=1, cex.axis=.8, mgp=c(0, .25, 0))
	mtext('MNase-seq signal', side=4, line=1)
...
plotsave(p, file='fig6.H9_Mhemi_MNase_Alu_start.pdf', height=2.3, width=3.2, units='in')

mC <- read.table('H9_BS_mCHG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
plotsave(p, file='fig6.H9_BS_MNase_Alu_start.pdf', height=2.3, width=3.2, units='in')




mC <- read.table('GM12878_Mhemi_mCHG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
p <- myplot({
	...
	axis(1, at=c(-100,0,100,200,300), labels=c(-100,0,100,200,300), tcl=-.1, lwd=1, lwd.ticks=1, las=1, cex.axis=.8, mgp=c(0, 0, 0))
	mtext('Distance from Alu start sites (bp)', side=1, cex=0.9, line=1)
	axis(4, at=c(0,.8,1.6), labels=c(0,.8,1.6), tcl=-.1, lwd=1, lwd.ticks=1, las=1, cex.axis=.8, mgp=c(0, .25, 0))
	mtext('MNase-seq signal', side=4, line=1)
...
plotsave(p, file='fig6.GM12878_Mhemi_MNase_Alu_start.pdf', height=2.3, width=3.2, units='in')

mC <- read.table('GM12878_BS_mCHG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
plotsave(p, file='fig6.GM12878_BS_MNase_Alu_start.pdf', height=2.3, width=3.2, units='in')
