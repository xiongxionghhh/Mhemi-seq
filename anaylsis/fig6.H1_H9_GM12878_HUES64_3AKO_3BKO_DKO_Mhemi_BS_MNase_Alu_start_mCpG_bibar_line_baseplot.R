...
mC <- read.table('H1_Mhemi_mCpG_Alu_Start.txt', sep='\t', header=T)
...
p <- myplot({
	...
	mtext('Mhemi-seq mCpG (%)', side=2, cex=0.9, line=1)
	par(new=TRUE)
...
plotsave(p, file='fig6.H1_Mhemi_MNase_Alu_start_mCpG.pdf', height=2.3, width=3.2, units='in')

mC <- read.table('H1_BS_mCpG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
plotsave(p, file='fig6.H1_BS_MNase_Alu_start_mCpG.pdf', height=2.3, width=3.2, units='in')



mC <- read.table('H9_Mhemi_mCpG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
plotsave(p, file='fig6.H9_Mhemi_MNase_Alu_start_mCpG.pdf', height=2.3, width=3.2, units='in')

mC <- read.table('H9_BS_mCpG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
plotsave(p, file='fig6.H9_BS_MNase_Alu_start_mCpG.pdf', height=2.3, width=3.2, units='in')




mC <- read.table('GM12878_Mhemi_mCpG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
plotsave(p, file='fig6.GM12878_Mhemi_MNase_Alu_start_mCpG.pdf', height=2.3, width=3.2, units='in')

mC <- read.table('GM12878_BS_mCpG_Alu_Start.txt', sep='\t', header=T)
mC$Methylation[which(mC$Strand=='oppo')] <- -1*mC$Methylation[which(mC$Strand=='oppo')]
tmpOppo <- subset(mC, Strand=='oppo', select=-3)
colnames(tmpOppo)[2] <- 'oppo'
tmpSame <- subset(mC, Strand=='same', select=-3)
...
plotsave(p, file='fig6.GM12878_BS_MNase_Alu_start_mCpG.pdf', height=2.3, width=3.2, units='in')
